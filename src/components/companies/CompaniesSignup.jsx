...
import companiessignupbackground from '../../assets/companiessignup.jpg'
...
function CompaniesSignup() {
  ...
  const backendUrl = 'http://localhost:5000/companies/signup'
  ...
  return (
    <>
      <div className='w-screen h-screen bg-cover' style={{ backgroundImage: `url(${companiessignupbackground})` }}>
      <div className="min-h-screen flex items-center justify-center">
        <div className="bg-white p-8 rounded shadow-lg max-w-md w-full animate__animated animate__fadeInDown">
          ...
          <div className="flex justify-between">
            ...
            <Link to={'/companies/login'}><button className="bg-gray-500 text-white py-2 px-4 rounded hover:bg-gray-600 w-full sm:w-auto">Back</button></Link>
          </div>
          </form>
        </div>
      </div>
