...
function InstitutionsSignup() {
  ...
  return (
    <>
      <div className='w-screen h-screen bg-cover' style={{ backgroundImage: `url(${Institutionssignupbackground})` }}>
          ...
          <div className="bg-white p-8 rounded shadow-lg max-w-md w-full animate__animated animate__fadeInDown">
            ...
            <form onSubmit={submit}  action='/post'>
              ...
              <div className="flex justify-between">
                ...
                <Link to={'/institutions/login'}><button className="bg-gray-500 text-white py-2 px-4 rounded hover:bg-gray-600 w-full sm:w-auto">Back</button></Link>
              </div>
            </form>
          </div>
        </div>
...
export default InstitutionsSignup